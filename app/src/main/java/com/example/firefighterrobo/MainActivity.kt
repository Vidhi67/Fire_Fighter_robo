package com.example.firefighterrobo
...
import com.example.firefighterrobo.ui.theme.FireFighterRoboTheme
...
class MainActivity : ComponentActivity() {
    ...
    private var pause by Delegates.notNull<Int>()
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val interactionSource4= MutableInteractionSource()
        ...
        setContent {
            ...
            pause = if (interactionSource4.collectIsPressedAsState().value) 1 else 0
            ...
            val postListener = object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    database.child("stop").setValue(pause)
                ...
                Surface(
                    ...
                    Column(modifier = Modifier
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically,
                            ...
                            LargeFloatingActionButton(onClick ={} , interactionSource = interactionSource4) {
                                Icon(Icons.Filled.Stop, contentDescription = "Reverse", modifier = Modifier.size(100.dp))
